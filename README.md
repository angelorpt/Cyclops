...
**Cyclops** é um aplicativo desenvolvido na linguagem de Script chamada [AutoHotkey](https://www.autohotkey.com). E tem por objetivo tornar o usuário mais eficiente ao utilizar o Sistema Operacional Windows. Especialmente desenvolvedores.
